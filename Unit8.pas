...
type
  Tuser = class(TForm)
    ...
    frxrprt1: TfrxReport;
    dzqry1id: TIntegerField;
    dzqry1username: TIntegerField;
    dzqry1password: TIntegerField;
    dzqry1level: TStringField;
    dzqry1status: TStringField;
...
if edt2.Text ='' then
begin
ShowMessage('PASWWORD TIDAK BOLEH KOSONG!');
end else
if edt3.Text ='' then
begin
