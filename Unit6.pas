...
type
  Tkelas = class(TForm)
    ...
    zqry1nama: TStringField;
    zqry1jurusan: TStringField;
...
procedure Tkelas.FormShow(Sender: TObject);
begin
posisiawal;
end;
...
ShowMessage('DATA BERHASIL DIUPDATE!');
  zqry1.SQL.Clear;
  zqry1.SQL.Add('Update kelas set nama= "'+edt1.Text+'",jurusan="'+edt2.Text+'" where kelas="'+id+'"');
  zqry1. ExecSQL;
...
procedure Tkelas.dbgrd1CellClick(Column: TColumn);
begin
